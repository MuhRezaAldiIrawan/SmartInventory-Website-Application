          ...
          <div class="container">
              <div class="row justify-content-center pt-100">
                  <div class="col-md-6 text-center mb-4">
                      <h2 class="heading-section">Barang Keluar</h2>
                  </div>
              </div>
                      ...
                      <div class="table-wrap">
                        ...
                        foreach($barangkeluar as $brk) : ?>
                              <tr class="alert" role="alert">
                                  ...
                                  <td class="text-center"><?php echo $brk->nama ?></td>
                                  <td class="text-center"><?php echo $brk->harga ?></td>
                                  <td class="text-center"><?php echo $brk->jumlah ?></td>
                                  <td class="text-center"><?php echo $brk->gambar ?></td>
                              </tr>
                              <?php endforeach; ?>
                          </table>
                      </div>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <form action="<?php echo base_url().'barangkeluar/barangkeluar/tambah_aksi' ?>" method="POST"
