            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tr>
                            <td><?php echo $no++ ?></td>
                            <td><?php echo $brm->nama ?></td>
                            <td><?php echo $brm->harga ?></td>
                            <td><?php echo $brm->jumlah ?></td>
                            <td><?php echo $brm->gambar ?></td>
                            <td><?php echo anchor('listadmin/listadmin/editmasuk/' .$brm->id, '<div class="btn btn-success btn-sm"><i class="fas fas fa-edit"></i></div>') ?>
                            </td>
                            <td><?php echo anchor('listadmin/listadmin/hapusmasuk/' .$brm->id, '<div class="btn btn-danger btn-sm"><i class="fas fas fa-trash"></i></div>') ?>
                            </td>
                </div>
                </tr>
                <?php endforeach; ?>
