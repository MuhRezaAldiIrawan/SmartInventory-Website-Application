                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tr>
                            ...
                            <td><?php echo anchor('listadmin/listadmin/edit/' .$pds->id, '<div class="btn btn-success btn-sm"><i class="fas fas fa-edit"></i></div>') ?>
                            </td>
                            <td><?php echo anchor('listadmin/listadmin/hapus/' .$pds->id, '<div class="btn btn-danger btn-sm"><i class="fas fas fa-trash"></i></div>') ?>
                            </td>
                </div>
                </tr>
                <?php endforeach; ?>
