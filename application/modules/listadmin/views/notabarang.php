            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tr>
                            <td><?php echo $no++ ?></td>
                            <td><?php echo $nta->tanggal ?></td>
                            <td><?php echo $nta->produsen ?></td>
                            <td><?php echo $nta->nama ?></td>
                            <td><?php echo $nta->jumlah ?></td>
                            <td><?php echo $nta->total ?></td>
                            <td><?php echo $nta->gambar ?></td>
                            <td><?php echo anchor('listadmin/listadmin/editnota/' .$nta->id, '<div class="btn btn-success btn-sm"><i class="fas fas fa-edit"></i></div>') ?>
                            </td>
                            <td><?php echo anchor('listadmin/listadmin/hapusnota/' .$nta->id, '<div class="btn btn-danger btn-sm"><i class="fas fas fa-trash"></i></div>') ?>
                            </td>
                </div>
                </tr>
                <?php endforeach; ?>
