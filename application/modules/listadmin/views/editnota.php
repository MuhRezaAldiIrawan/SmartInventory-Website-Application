        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="<?php echo base_url().'listadmin/listadmin/updatenota' ?>">
                        <div class="for-group">
                            <label>Tanggal</label>
                            <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $nta->id ?>">
                            <input type="text" name="tanggal" id="tanggal" class="form-control"
                                value="<?php echo $nta->tanggal ?>" readonly>
                        </div>
                        <div class="for-group">
                            <label>Produsen</label>
                            <input type="text" name="produsen" id="produsen" class="form-control"
                                value="<?php echo $nta->produsen ?>">
                        </div>
                        <div class="for-group">
                            <label>Nama</label>
                            <input type="text" name="nama" id="nama" class="form-control"
                                value="<?php echo $nta->nama ?>">
                        </div>
                        <div class="for-group">
                            <label>Jumlah</label>
                            <input type="text" name="jumlah" id="jumlah" class="form-control"
                                value="<?php echo $nta->jumlah ?>">
                        </div>
                        <div class="for-group">
                            <label>Total</label>
                            <input type="text" name="total" id="total" class="form-control"
                                value="<?php echo $nta->total ?>">
                        </div>
                        <div class="for-group">
                            <label>Gambar</label>
                            <input type="text" name="gambar" id="gambar" class="form-control"
                                value="<?php echo $nta->gambar ?>" readonly>
                        </div>
                        <button type="submit" class="btn btn-primary btn-sm mt-3">Simpan Data</button>
                    </form>
                    <?php endforeach; ?>
                </div>
            </div>
