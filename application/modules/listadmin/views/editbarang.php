        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="post" action="<?php echo base_url().'listadmin/listadmin/updatebarang' ?>">
                        <div class="for-group">
                            <label>Nama Produk</label>
                            <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $dtb->id ?>">
                            <input type="text" name="nama" id="nama" class="form-control"
                                value="<?php echo $dtb->nama ?>">
                        </div>
                        <div class="for-group">
                            <label>Harga</label>
                            <input type="text" name="harga" id="harga" class="form-control"
                                value="<?php echo $dtb->harga ?>">
                        </div>
                        <div class="for-group">
                            <label>Stok Barang</label>
                            <input type="text" name="stok" id="stok" class="form-control"
                                value="<?php echo $dtb->stok ?>">
                        </div>
                        <div class="for-group">
                            <label>Produsen Barang</label>
                            <input type="text" name="produsen" id="produsen" class="form-control"
                                value="<?php echo $dtb->produsen ?>">
                        </div>
                        <div class="for-group">
                            <label>Detail</label>
                            <input type="text" name="detail" id="detail" class="form-control"
                                value="<?php echo $dtb->detail ?>">
                        </div>
