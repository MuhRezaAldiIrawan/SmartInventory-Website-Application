        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3>Edit Data</h3>
                    <?php foreach($barangmasuk as $brm) : ?>
                    <form method="post" action="<?php echo base_url().'listadmin/listadmin/updatemasuk' ?>">
                        <div class="for-group">
                            <label>Nama Barang</label>
                            <input type="hidden" name="id" id="id" class="form-control" value="<?php echo $brm->id ?>">
                            <input type="text" name="nama" id="nama" class="form-control"
                                value="<?php echo $brm->nama ?>">
                        </div>
                        <div class="for-group">
                            <label>Harga Barang</label>
                            <input type="text" name="harga" id="harga" class="form-control"
                                value="<?php echo $brm->harga ?>">
                        </div>
                        <div class="for-group">
                            <label>Jumlah Barang</label>
                            <input type="text" name="jumlah" id="jumlah" class="form-control"
                                value="<?php echo $brm->jumlah ?>">
                        </div>
                        <div class="for-group">
                            <label>Gambar</label>
                            <input type="text" name="gambar" id="gambar" class="form-control"
                                value="<?php echo $brm->gambar ?>" readonly>
                        </div>
